...
public class Homography {
  ...
  public PMatrix3D tansformationMatrix() {
    ...
    public static HomographyMatrix getSquareToQuad(double theX0, double theY0, double theX1, double theY1, double theX2, double theY2, double theX3, double theY3) {
